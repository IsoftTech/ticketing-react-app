          ...
          <section className="carousel-category carousel-random">
            <div className="carousel-item">
              <div className="carousel-img">
                <img src="assets/images/huge.jpg" alt="huge" />
              </div>
            ...
            <div className="carousel-item">
              <div className="carousel-img">
                <img src="assets/images/huge-2.jpg" alt="huge" />
              </div>
              <div className="carousel-text">
                <h4>NFL</h4>
              </div>
            ...
            <div className="carousel-item">
              <div className="carousel-img">
                <img src="assets/images/huge-3.jpg" alt="huge" />
              </div>
              <div className="carousel-text">
                <h4>MLB</h4>
              </div>
            ...
            <div className="carousel-item">
              <div className="carousel-img">
                <img src="assets/images/huge-4.jpg" alt="huge" />
              </div>
              <div className="carousel-text">
                <h4>NBA</h4>
              </div>
            ...
            <div className="carousel-item">
              <div className="carousel-img">
                <img src="assets/images/huge-5.jpg" alt="huge" />
              </div>
              <div className="carousel-text">
                <h4>NHL</h4>
              </div>
            ...
            <div className="carousel-item">
              <div className="carousel-img">
                <img src="assets/images/huge-6.jpg" alt="huge" />
              </div>
              <div className="carousel-text">
                <h4>MLS</h4>
              </div>
